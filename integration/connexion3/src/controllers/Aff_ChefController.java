 ...
 */
public class Aff_ChefController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
                        ChefCantineCrud ac = new ChefCantineCrud();
        try {
            ...
            Logger.getLogger(Aff_ChefController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
