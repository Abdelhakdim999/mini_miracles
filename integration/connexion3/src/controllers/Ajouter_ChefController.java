 ...
 */
public class Ajouter_ChefController implements Initializable {
    ...
    private void val(ActionEvent event) {
        ChefCantineCrud ccc = new ChefCantineCrud();
        ...
        Chef_cantine c = new Chef_cantine();
        c.setNom(txt1);
        c.setPrenom(txt2);
        c.setMail(txt3);
        c.setTel(txt4);
