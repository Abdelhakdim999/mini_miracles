 ...
 */
public class Gestion_sujet_parentController implements Initializable {
    Parent root;
    private int idparent;

    public Gestion_sujet_parentController(int idparent) {
    ...
    private void changeScreenButton(ActionEvent event) throws IOException {
        Node node = (Node) event.getSource();
                ...
                //stage.setMaximized(true);
                stage.close();
                AjouterSujet_parentController enfCon = new AjouterSujet_parentController(idparent);
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AjouterSujet_parent.fxml"));
    ...
    private void changeScreenButton1(ActionEvent event) throws IOException {
        Node node = (Node) event.getSource();
                ...
                //stage.setMaximized(true);
                stage.close();
                UpdateDelete_parentController enfCon = new UpdateDelete_parentController(idparent);
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/UpdateDelete_parent.fxml"));
                loader.setController(enfCon);
                root = loader.load();
                Scene scene = new Scene(root);
                stage.setScene(scene);
    ...
    private void changerDetail(ActionEvent event) throws IOException {
        Node node = (Node) event.getSource();
                ...
                //stage.setMaximized(true);
                stage.close();
                Aff_Forum_ParentController enfCon = new Aff_Forum_ParentController(idparent);
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/Aff_Forum_Parent.fxml"));
                loader.setController(enfCon);
                root = loader.load();
                Scene scene = new Scene(root);
                stage.setScene(scene);
