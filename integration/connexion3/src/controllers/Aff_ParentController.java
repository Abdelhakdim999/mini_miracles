 ...
 */
public class Aff_ParentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            nbr.setCellValueFactory(new PropertyValueFactory<>("nb_enfants"));
            // TODO
        } catch (SQLException ex) {
            Logger.getLogger(Aff_ParentController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
